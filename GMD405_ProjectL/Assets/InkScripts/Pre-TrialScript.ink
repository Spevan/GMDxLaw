...
EXTERNAL GetName()
EXTERNAL SetScript(scriptName)

{AddChar("Verdict", "Neutral")}
{ChangeName("")}
(The day of the trial...)
(The door swings open and in front of you is the courtroom where justice will be decided upon today.)
(A man from the defense side stands and turns towards you.)
